...
public partial class centerstyle_featurefilm : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        hotnewShow.InnerHtml = BaseClass.ShowListLabel(out recordcount, "Label=WEB_热点排行新闻列表", "NodeId=61", "startRow=0", "LastRowNum=10").ToString();
        NewsInfoBind();
    }
