...
public partial class centerstyle_focus8890 : System.Web.UI.Page
{
    ...
    private void NewsInfoBind()
    {
        ...
        NewsShow.InnerHtml = BaseClass.ShowListLabel(out recordcount, "Label=WEB_聚焦8890一列式列表", "NodeId=60", "startRow=" + startRow, "LastRowNum=" + LastRowNum).ToString();
