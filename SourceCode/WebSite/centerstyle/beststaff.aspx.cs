...
public partial class centerstyle_beststaff : System.Web.UI.Page
{
    ...
    private void NewsInfoBind()
    {
        ...
        beststaffShow.InnerHtml = BaseClass.ShowListLabel(out recordcount, "Label=WEB_优秀员工一列式列表", "NodeId=62", "startRow=" + startRow, "LastRowNum=" + LastRowNum).ToString();
