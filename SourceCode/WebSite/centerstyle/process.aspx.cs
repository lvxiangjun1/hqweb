...
public partial class centerstyle_process : System.Web.UI.Page
{
    ...
    private void NewsInfoBind()
    {
        ...
        beststaffShow.InnerHtml = BaseClass.ShowListLabel(out recordcount, "Label=WEB_二周年历程一列式列表", "NodeId=64", "startRow=" + startRow, "LastRowNum=" + LastRowNum).ToString();
