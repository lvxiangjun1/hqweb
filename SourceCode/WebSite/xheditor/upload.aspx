 ...
 */
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string attachdir = Request.ApplicationPath + "/uploadfile";     // 上传文件保存路径，结尾不要带/
        int dirtype = 1;                 // 1:按天存入目录 2:按月存入目录 3:按扩展名存目录  建议使用按天存
        int maxattachsize = 2097152;     // 最大上传大小，默认是2M
        string upext = "xlsx,xls,docx,doc,txt,rar,zip,jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid";    // 上传扩展名
        string imgupext = "jpg,jpeg,gif,png";
        string fileupext = "xlsx,xls,docx,doc,txt,rar,zip";
        string movieupext = "swf,wmv,avi,wma,mp3,mid";
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string checkdir = System.Web.HttpContext.Current.Request.PhysicalApplicationPath + @"uploadfile\" + attach_subdir + "\\" + filename;

                    if (("," + imgupext + ",").IndexOf("," + extension + ",") > 0)
                    {
