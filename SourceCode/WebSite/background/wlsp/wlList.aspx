<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wlList.aspx.cs" Inherits="background_wlsp_wlList" %>
...
<body>
    ...
    <div class="mainTop">
        ...
        <div class="mainSearch2">
            <asp:Button ID="btnAdd9" runat="server" Text="添加" OnClick="btnAdd_Click" CssClass="scbtn2" />
        </div>
        <div class="mainContant">
            <div class="tableclock">
                <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
                    <tr>
                        ...
                        <td class="wenzi1" width="33%">
                            <asp:RadioButtonList ID="rblStatus" runat="server" RepeatDirection="Horizontal" CssClass="chkListItem" Width="150px">
                                <asp:ListItem Value="0" Selected="True">已发布</asp:ListItem>
                                <asp:ListItem Value="-1">已删除</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                        <td width="10%" align="center" class="wenzi1">
                            <asp:Button ID="BtnSearch" runat="server" Text="搜索" OnClick="BtnSearch_Click" CssClass="scbtn" Width="88px" />
                        </td>
                    </tr>
                </table>
            </div>
            <asp:GridView ID="GridViewNews" CssClass="tableclock2" CellSpacing="1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ISSPECIAL" HeaderText="首页显示">
                    ...
                    <asp:TemplateField HeaderText="预览" ShowHeader="False">
                        <ItemStyle ForeColor="Red" HorizontalAlign="Center" Width="40px" />
                        <ItemTemplate>
                            <asp:ImageButton ID="LinkBtnSel" runat="server" ImageUrl="../images/xiangxi.gif"
                                AlternateText="预览" OnClick="LinkBtnSel_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>
