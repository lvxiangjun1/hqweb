<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zxList.aspx.cs" Inherits="background_zxsj_zxList" %>
...
<body>
    ...
    <div class="mainTop">
        ...
        <div class="mainTopRight">
            &nbsp;</div><div class="mainSearch2"><asp:Button ID="btnAdd4" runat="server" Text="添加" OnClick="btnAdd_Click" CssClass="scbtn2" /></div> 
    </div>
