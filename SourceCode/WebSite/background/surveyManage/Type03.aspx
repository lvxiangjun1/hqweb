<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Type03.aspx.cs" Inherits="background_surveyManage_Type03" %>
...
<body>
    <form id="Type03Form" runat="server">
    <div class="mainTop">
    ...
    <div class="mainContant">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tableclock">
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:RadioButtonList ID="chkList" runat="server" AutoPostBack="True" OnSelectedIndexChanged="chkList_SelectedIndexChanged">
            ...
            <tr>
                ...
                <td class="wenzi1">
                    ...
                    <asp:Button ID="btnSetText" runat="server" Text="设置文本框" OnClick="btnSetText_Click"
                        CssClass="buttom44" />
                    <asp:Button ID="btnConcelText" runat="server" Text="取消文本框" OnClick="btnConcelText_Click"
                        CssClass="buttom44" />
                </td>
            </tr>
            <tr>
