<%@ Page Language="C#" AutoEventWireup="true" CodeFile="surveyCreate.aspx.cs" Inherits="background_surveyManage_surveyCreate" %>
    ...
    <div class="mainContant">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tableclock">
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:DropDownList ID="dropIsPublish" runat="server" Width="120px" Enabled="false">
