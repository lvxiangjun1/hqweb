...
using System.Data;
using Web.News;
public partial class background_lkcx_lkList : BasePage
{
    Base b = new Base();
    ...
    private void GridViewDataBind()
    {
        ...
        Int32 recordcount;
        string sql = "SELECT * FROM T_NEWSBASE WHERE NODEID=45 and STATUS=" + this.rblStatus.SelectedValue;
    ...
    protected void LinkBtnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("lkEdit.aspx?id=" + id);
    }
    ...
    protected void LinkBtnSel_Click(object sender, ImageClickEventArgs e)
    {
        GridViewRow rows = (GridViewRow)((Control)sender).Parent.Parent;
        string id = GridViewNews.DataKeys[rows.RowIndex].Values["ID"].ToString();
        RunJs("window.open('lkSel.aspx?id=" + id + "')");
    }
