<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wlEdit.aspx.cs" Inherits="Background_wlkt_wlEdit" %>
...
<body>
    ...
    <div class="mainTop">
        <div class="mainTopTitle">
            修改<span class="style1"><span lang="EN-US">8890</span><span>网络课堂</span></span></div>
    ...
    <div class="mainContant">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tableclock">
            ...
            <tr>
                <td colspan="4" class="wenzi1" align="center" style="padding-top: 5px; padding-bottom: 5px;">
