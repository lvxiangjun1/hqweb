<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProList.aspx.cs" Inherits="background_product_ProList" %>
        ...
        <div class="tableclock">
            <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
                <tr>
                    ...
                    <td class="wenzi1">
                        <asp:DropDownList ID="TxtCARCOLOR" runat="server" Width="150px">
                        </asp:DropDownList>
                    </td>
                    <td width="12%" align="center" class="wenziNew">
                        状态：
                    ...
                    <td width="60px" rowspan="2" class="wenzi1" align="center">
        ...
        <asp:GridView ID="GridViewNews" CssClass="tableclock2" CellSpacing="1" runat="server"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PRONAME" HeaderText="产品名称">
                 ...
                 <asp:BoundField DataField="BAND" HeaderText="品牌">
                    <ItemStyle HorizontalAlign="left" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="产品类型">
                    <ItemTemplate>
                        <asp:Label ID="lbTitle" runat="server" Text='<%# Bind("PROTYPE") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                  <asp:BoundField DataField="PROSTATUS" HeaderText="产品状态">
                    <ItemStyle HorizontalAlign="left" />
                </asp:BoundField>
                <asp:BoundField DataField="MEMBERID" HeaderText="添加人">
                    <ItemStyle HorizontalAlign="Center" Width="80px" />
                </asp:BoundField>
