<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProEdit.aspx.cs" Inherits="background_product_ProEdit" %>
    ...
    <div class="mainContant">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tableclock">
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:TextBox ID="txtProstatus" runat="server" Width="280"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="center" class="wenziNew">
