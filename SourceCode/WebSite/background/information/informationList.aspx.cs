...
using System.Data;
using Web.News;
public partial class Background_information_informationList : BasePage
{
    Base b = new Base();
    ...
    {
        Response.Redirect("informationAdd.aspx");
    }
    ...
    protected void LinkBtnEdit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("informationEdit.aspx?id=" + id);
    }
    protected void BtnDelete_Click(object sender, ImageClickEventArgs e)
    {
        GridViewRow rows = (GridViewRow)((Control)sender).Parent.Parent;
        string id = GridViewNews.DataKeys[rows.RowIndex].Values["ID"].ToString();
        string strSql = "DELETE FROM T_NEWSBASE WHERE ID = " + id;
    ...
    protected void LinkBtnSel_Click(object sender, ImageClickEventArgs e)
    {
        GridViewRow rows = (GridViewRow)((Control)sender).Parent.Parent;
        string id = GridViewNews.DataKeys[rows.RowIndex].Values["ID"].ToString();
        RunJs("window.open('informationSel.aspx?id=" + id + "')");
    }
}