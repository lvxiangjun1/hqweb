<%@ Page Language="C#" AutoEventWireup="true" CodeFile="informationList.aspx.cs"
    Inherits="Background_information_informationList" %>
...
<body>
    <form id="informationListForm" runat="server">
    <div class="mainTop">
        ...
        <div class="mainSearch2">
            <asp:Button ID="btnAdd4" runat="server" Text="添加" OnClick="btnAdd_Click" CssClass="scbtn2" /></div>
    </div>
        ...
        <div class="tableclock">
            <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="60px" align="center" class="wenzi1">
