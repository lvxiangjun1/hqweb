<%@ Page Language="C#" AutoEventWireup="true" CodeFile="featurefilm.aspx.cs" Inherits="Background_centerstyleManage_featurefilm" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Check() {
            if (featurefilmForm.txtTITLE.value == "") {
                alert("标题不能为空！！");
                featurefilmForm.txtTITLE.focus();
                return false;
            }
...
<body>
    <form id="featurefilmForm" runat="server">
    <div class="mainTop">
