...
using System.IO;
using Web.News;
public partial class background_centerstyleManage_beststaffManage_beststaffEdit : BasePage
{
    ...
    private void BestStaffInfoBind()
    {
        ...
        if (int.TryParse(ID, out i))
        {
            ...
            if (FM.IsPersistent)
            {
                ...
                txtSubTitle.Text = FM.SUBTITLE.ToString();
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (int.TryParse(txtID.Text, out i))
        {
            ...
            if (FM.IsPersistent)
            {
                ...
                FM.SUBTITLE = txtSubTitle.Text.Trim();
