...
using Web.News;
public partial class background_centerstyleManage_beststaffManage_beststaffList : BasePage
{
    ...
    {
        Response.Redirect("beststaffAdd.aspx");
    }
    ...
    {
        Response.Redirect("beststaffEdit.aspx?ID=" + GridViewDoctor.Rows[e.NewEditIndex].Cells[0].Text);
    }
}