<%@ Page Language="C#" AutoEventWireup="true" CodeFile="beststaffList.aspx.cs" Inherits="background_centerstyleManage_beststaffManage_beststaffList" %>
...
<body>
    <form id="beststaffListForm" runat="server">
    <div class="mainTop">
    ...
    <div class="mainContant">
        <asp:GridView ID="GridViewDoctor" CssClass="tableclock2" CellSpacing="1" runat="server"
            ...
            OnRowDeleting="GridViewDoctor_RowDeleting" OnRowEditing="GridViewDoctor_RowEditing" Width="100%">
            <Columns>
                ...
                <asp:BoundField DataField="SUBTITLE" HeaderText="格言">
