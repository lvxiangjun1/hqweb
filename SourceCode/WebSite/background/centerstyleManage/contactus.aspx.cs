...
using Web.News;
public partial class Background_centerstyleManage_contactus : BasePage
{
    Base b = new Base();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                strSql = "INSERT INTO T_WEBINFO (ID,TITLE,CONTENT) VALUES (8,'','')";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        mycon.Open();
        string strSql = "UPDATE T_WEBINFO SET TITLE = '" + Names.GetSingQuote(txtTITLE.Text.Trim()) + "',CONTENT = :content WHERE ID = 8";
