<%@ Page Language="C#" AutoEventWireup="true" CodeFile="introduce.aspx.cs" Inherits="Background_centerstyleManage_introduce" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Check() {
            if (introduceForm.txtTITLE.value == "") {
                alert("标题不能为空！！");
                introduceForm.txtTITLE.focus();
                return false;
            }
...
<body>
    <form id="introduceForm" runat="server">
    <div class="mainTop">
