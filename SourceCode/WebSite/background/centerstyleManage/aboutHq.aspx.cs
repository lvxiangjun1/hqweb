...
using Web.News;
public partial class background_centerstyleManage_aboutHq : BasePage
{
    Base b = new Base();
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string strSql = "SELECT * FROM T_WEBINFO WHERE ID = 9";
            ...
            {
                strSql = "INSERT INTO T_WEBINFO (ID,TITLE,CONTENT) VALUES (9,'','')";
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        mycon.Open();
        string strSql = "UPDATE T_WEBINFO SET TITLE = '" + Names.GetSingQuote(txtTITLE.Text.Trim()) + "',CONTENT = :content WHERE ID =9";
