<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contactus.aspx.cs" Inherits="Background_centerstyleManage_contactus" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Check() {
            if (contactusForm.txtTITLE.value == "") {
                alert("标题不能为空！！");
                contactusForm.txtTITLE.focus();
                return false;
            }
