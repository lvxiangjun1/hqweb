<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsList.aspx.cs" Inherits="background_adminManage_adminList" %>
...
<body>
    ...
    <div class="mainTop">
        ...
        <div class="mainTopRight">
            &nbsp;</div> <div class="mainSearch2"> <asp:Button ID="btnAdd3" runat="server" Text="添加" OnClick="btnAdd_Click" CssClass="scbtn2" /></div>
    </div>   
    ...
    <div  class="tableclock">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center">
            <tr>
                ...
                <td class="wenzi1">
                    <asp:TextBox ID="txtSUBTITLE" runat="server" CssClass="scinput"></asp:TextBox>
                </td>
                   <td width="12%" align="center" class="wenziNew">
                    状态：
                </td>
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:TextBox ID="txtAUTHOR" runat="server" CssClass="scinput"></asp:TextBox>
                </td>
                <td width="12%" align="center" class="wenziNew">
                    是否首页显示：
                </td>
