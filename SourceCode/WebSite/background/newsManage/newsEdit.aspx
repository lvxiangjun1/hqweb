<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newsEdit.aspx.cs" Inherits="Background_NewsManage_newsEdit" %>
    ...
    <div class="mainContant">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" class="tableclock">
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:DropDownList ID="uploadList" runat="server" Width="130px">
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td class="wenzi1">
                    <asp:DropDownList ID="ddlISSPECIAL" runat="server" Width="130px">
