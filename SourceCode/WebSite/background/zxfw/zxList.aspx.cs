...
using System.Data;
using Web.News;
public partial class background_zxfw_zxList : BasePage
{
    Base b = new Base();
    ...
    private void GridViewDataBind()
    {
        ...
        Int32 recordcount;
        string sql = "SELECT * FROM T_NEWSBASE WHERE NODEID=68 and STATUS=" + this.rblStatus.SelectedValue;
