<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dtList.aspx.cs" Inherits="background_dtly_dtList" %>
...
<body>
    <form id="dtList" runat="server">
    <div class="mainTop">
        <div class="mainTopTitle">
            短途旅游攻略</div>
        <div class="mainTopRight">
            &nbsp;</div><div class="mainSearch2"> <asp:Button ID="btnAdd11" runat="server" Text="添加" OnClick="btnAdd_Click" CssClass="scbtn2" /></div> 
    </div>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" >
            <tr>
                ...
                <td class="wenzi1" colspan="3">
                   ...
                   <td rowspan="2" width="60px" align="center" class="wenzi1">
