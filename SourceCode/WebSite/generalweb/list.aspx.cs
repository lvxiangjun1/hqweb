...
public partial class generalweb_list : System.Web.UI.Page
{
    ...
    private void NewsBind()
    {
        ...
        if (int.TryParse(ID, out i))
        {
            ...
            NewsShow.InnerHtml = BaseClass.ShowListLabel(out recordcount, "Label=WEB_通用新闻一列式列表", "NodeId=" + ID, "startRow=" + startRow, "LastRowNum=" + LastRowNum).ToString();
