...
namespace Web.BusinessEntity
{
    ...
    [Serializable()]
    public class SYS_USER_LAWEntity : EntityObject
    {
        ...
        /// <summary>NB_LAWID</summary>
        public const string @__NB_LAWID = "NB_LAWID";
        ...
        /// <summary>属性NB_LAWID </summary>
        public decimal NB_LAWID
        {
            get
            {
                return this.m_NB_LAWID;
            }
            set
            {
                this.m_NB_LAWID = value;
            }
        }
    ...
    /// SYS_USER_LAWEntity执行类
    public abstract class SYS_USER_LAWEntityAction
    {
        
        private SYS_USER_LAWEntityAction()
        {
        }
        
        public static void Save(SYS_USER_LAWEntity obj)
        {
            if (obj!=null)
            {
                obj.Save();
        ...
        public static SYS_USER_LAWEntity RetrieveASYS_USER_LAWEntity(decimal NB_ID)
        {
            SYS_USER_LAWEntity obj=new SYS_USER_LAWEntity();
            obj.NB_ID=NB_ID;
            obj.Retrieve();
            if (obj.IsPersistent)
            {
        ...
        public static EntityContainer RetrieveSYS_USER_LAWEntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(SYS_USER_LAWEntity));
            return rc.AsEntityContainer();
        }
        
        /// <summary>获取所有实体(EntityContainer)</summary>
        public static DataTable GetSYS_USER_LAWEntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(SYS_USER_LAWEntity));
