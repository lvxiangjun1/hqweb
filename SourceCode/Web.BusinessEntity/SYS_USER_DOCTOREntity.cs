...
namespace Web.BusinessEntity
{
    ...
    [Serializable()]
    public class SYS_USER_DOCTOREntity : EntityObject
    {
        ...
        /// <summary>NB_DOCTORID</summary>
        public const string @__NB_DOCTORID = "NB_DOCTORID";
        ...
        /// <summary>属性NB_DOCTORID </summary>
        public decimal NB_DOCTORID
        {
            get
            {
                return this.m_NB_DOCTORID;
            }
            set
            {
                this.m_NB_DOCTORID = value;
            }
        }
    ...
    /// SYS_USER_DOCTOREntity执行类
    public abstract class SYS_USER_DOCTOREntityAction
    {
        
        private SYS_USER_DOCTOREntityAction()
        {
        }
        
        public static void Save(SYS_USER_DOCTOREntity obj)
        {
            if (obj!=null)
            {
                obj.Save();
        ...
        public static SYS_USER_DOCTOREntity RetrieveASYS_USER_DOCTOREntity(decimal NB_ID)
        {
            SYS_USER_DOCTOREntity obj=new SYS_USER_DOCTOREntity();
            obj.NB_ID=NB_ID;
            obj.Retrieve();
            if (obj.IsPersistent)
            {
        ...
        public static EntityContainer RetrieveSYS_USER_DOCTOREntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(SYS_USER_DOCTOREntity));
            return rc.AsEntityContainer();
        }
        
        /// <summary>获取所有实体(EntityContainer)</summary>
        public static DataTable GetSYS_USER_DOCTOREntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(SYS_USER_DOCTOREntity));
