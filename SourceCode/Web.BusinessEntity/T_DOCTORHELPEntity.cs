...
namespace Web.BusinessEntity
{
    ...
    [Serializable()]
    public class T_DOCTORHELPEntity : EntityObject
    {
        ...
        public const string @__DOCTORID = "DOCTORID";
    ...
    /// T_DOCTORHELPEntity执行类
    public abstract class T_DOCTORHELPEntityAction
    {
        
        private T_DOCTORHELPEntityAction()
        {
        }
        
        public static void Save(T_DOCTORHELPEntity obj)
        {
            if (obj!=null)
            {
                obj.Save();
        ...
        public static T_DOCTORHELPEntity RetrieveAT_DOCTORHELPEntity(decimal ID)
        {
            T_DOCTORHELPEntity obj=new T_DOCTORHELPEntity();
            obj.ID=ID;
            obj.Retrieve();
            if (obj.IsPersistent)
            {
        ...
        public static EntityContainer RetrieveT_DOCTORHELPEntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(T_DOCTORHELPEntity));
            return rc.AsEntityContainer();
        }
        
        /// <summary>获取所有实体(EntityContainer)</summary>
        public static DataTable GetT_DOCTORHELPEntity()
        {
            RetrieveCriteria rc=new RetrieveCriteria(typeof(T_DOCTORHELPEntity));
